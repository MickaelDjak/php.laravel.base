    ...
    <div class="row">
        <div class="small-12 medium-4 large-2 large-offset-1 columns gnc-our-services-item">
            <div class="gnc-our-services-img">
                <img src="{{url('img/undraw/undraw_children_4rtb.svg')}}" alt="Kiwi standing on oval"/>
            </div>
            <a href="{{ route('resource_page', ['type'=>'post', 'slug'=>1]) }}" class="gnc-our-services-link">
        ...
        <div class="small-12 medium-4 large-2 columns gnc-our-services-item">
            <div class="gnc-our-services-img">
                <img src="{{url('img/undraw/undraw_people_tax5.svg')}}" alt="Kiwi standing on oval"/>
            </div>
            <a href="{{ route('resource_page', ['type'=>'post', 'slug'=>1]) }}" class="gnc-our-services-link">
        ...
        <div class="small-12 medium-4 large-2 columns gnc-our-services-item">
            <div class="gnc-our-services-img">
                <img src="{{url('img/undraw/undraw_wedding_t1yl.svg')}}" alt="Kiwi standing on oval"/>
            </div>
            <a href="{{ route('resource_page', ['type'=>'post', 'slug'=>1]) }}" class="gnc-our-services-link">
        ...
        <div class="small-12 medium-4 medium-offset-2 large-2 large-offset-0 columns gnc-our-services-item">
            <div class="gnc-our-services-img">
                <img src="{{url('img/undraw/undraw_fatherhood_7i19.svg')}}" alt="Kiwi standing on oval"/>
            </div>
            <a href="{{ route('resource_page', ['type'=>'post', 'slug'=>1]) }}" class="gnc-our-services-link">
        ...
        <div class="small-12 medium-4 large-2 columns gnc-our-services-item">
            <div class="gnc-our-services-img">
                <img src="{{url('img/undraw/undraw_baby_ja7a.svg')}}" alt="Kiwi standing on oval"/>
            </div>
            <a href="{{ route('resource_page', ['type'=>'post', 'slug'=>1]) }}" class="gnc-our-services-link">
